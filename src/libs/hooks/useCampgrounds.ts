...
export const useCampgrounds = () => {
  ...
  const getCampgrounds = async () => {
    ...
    setError(null);
    try {
      const data = await apiClient<{ data: Campground[] }>("/campgrounds");
